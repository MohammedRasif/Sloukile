...
const Banner = () => {
    return (
        <div className=" w-full lg:h-[95vh] md:h-[170vh] h-[130vh]  ">
            {/* Background Image */}
            <img
                src={img}
            ...
            {/* Overlay Content */}
            <div className="absolute top-0 left-0 w-full h-full flex flex-col lg:flex-row items-center justify-center text-white px-6 sm:px-8 md:px-12 lg:px-20 space-y-6 lg:space-y-0 lg:space-x-10 lg:mt-0 md:mt-30 mt-10">
                {/* Text Section */}
                <div className="text-center lg:text-left space-y-5 lg:space-y-7 lg:mt-[-100px]">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold leading-tight">
                        <span className="text-[#CBB702]">AI-Powered Project <br /> Management</span> for <br /> Smarter Execution
                    </h1>

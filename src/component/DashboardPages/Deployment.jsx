      ...
      <div className="container mx-auto">
        ...
        <div className="bg-white dark:bg-[#1E232E] rounded-xl shadow-lg p-6 mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-4 flex items-center gap-3">
            <Cloud className="h-6 w-6 text-blue-500 dark:text-blue-300" />
            Deployment Strategy
          </h2>
          ...
          <ul className="space-y-3">
            {[
              { title: "Cloud Infrastructure", desc: "AWS with ECS Fargate, SageMaker, and RDS for scalability and AI model hosting.", icon: <Cloud className="h-5 w-5 text-blue-500 dark:text-blue-300" /> },
              { title: "AI Model Deployment", desc: "Host task prioritization and NLP models on SageMaker endpoints with continuous training.", icon: <Cpu className="h-5 w-5 text-blue-500 dark:text-blue-300" /> },
              { title: "Blue-Green Deployment", desc: "Use blue-green deployments to ensure zero downtime during updates.", icon: <Rocket className="h-5 w-5 text-blue-500 dark:text-blue-300" /> },
              { title: "Monitoring", desc: "Implement Prometheus and Grafana for real-time AI and application metrics.", icon: <CheckCircle className="h-5 w-5 text-blue-500 dark:text-blue-300" /> },
            ].map((item, index) => (
        ...
        <div className="bg-white dark:bg-[#1E232E] rounded-xl shadow-lg p-6">
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={index} className="border-l-4 border-blue-500 dark:border-[#4A6CF7] pl-4">

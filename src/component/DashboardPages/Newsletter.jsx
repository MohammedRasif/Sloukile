                                ...
                                <div className="absolute z-10 mt-1 w-full bg-white dark:bg-[#2A2F3B] border border-gray-300 dark:border-gray-600 rounded-md shadow-lg max-h-60 overflow-auto">
                                    ...
                                    {filteredUsers.length > 0 ? (
                                        filteredUsers.map(user => (
                                            <div
                                                key={user.id}
                                                className={`p-2 hover:bg-gray-100 dark:hover:bg-[#353A47] cursor-pointer flex items-center ${selectedUsers.some(u => u.id === user.id) ? "bg-blue-50 dark:bg-blue-900/30" : ""
                                                    }`}
                                                onClick={(e) => {
                                                    e.stopPropagation()
                                                    toggleUserSelection(user)
